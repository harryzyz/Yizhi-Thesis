...
\begin{description}
\item[Step 1.\ Estimate and bound {$\Var(f')$}.] Compute  $\widetilde{V}_1(f,n_k)$ in \eqref{vtilde1}.
...
\begin{description}
\item[Step 1.\ Estimate and bound {$\Var(f''')$}.] Compute  $\widetilde{V}_3(f,n_k)$ in \eqref{vtilde3}.
